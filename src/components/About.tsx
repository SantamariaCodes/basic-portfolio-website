...
const About = React.forwardRef<HTMLDivElement>((props, ref) => (
  ...
  >
    <h2 className="my-5 pb-2 md:pb-4  lg:mb-12 420px:text-lg sm:text-2xl md:text-3xl lg:text-4xl text-center relative font-extrabold">
      ABOUT ME
      <span className="absolute left-1/2 bottom-0 transform translate-x-[-50%] w-[70%] h-1 bg-deepBlue"></span>
    </h2>
    <div className="text-left w-full md:flex md:space-x-4 gap-10  max-w-[1420px]">
