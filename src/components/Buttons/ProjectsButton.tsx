...
const ProjectsButton: React.FC<ProjectsButtonProps> = ({ onClick }) => {
  ...
  return (
    <button
      onClick={onClick}
      className="bg-deepBlue hover:bg-lessDeepBlue 420px:text-base text-sm sm:text-lg lg:text-xl  text-white  font-extrabold px-8 py-2  md:py-3 md:px-14 rounded"
    >
      {t("projects")}
    </button>
  );
